...
使用 Markdown 语法 `[@knuth84]` 引用文献 @knuth84。

这里演示如何引用公式 @eq-n-left。
...
这里演示如何引用表格 @tbl-algorithm-comparison。
...
这里演示如何引用图片 @fig-acoustic-pressure-level。

使用 Markdown 语法 `@fig-acoustic-pressure-level` 引用图片 @fig-acoustic-pressure-level。
