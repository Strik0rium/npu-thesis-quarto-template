...
macOS 上中文字体默认使用系统 **Songti SC** / **Heiti SC**；也可将 `simhei.ttf` 放入 `_thesis/fonts/` 作为黑体备份（见 [`_thesis/README.md`](_thesis/README.md)）。
...
**黑体显示异常**  
可将 `simhei.ttf` 复制到 `_thesis/fonts/`，或检查系统是否安装 Heiti SC / SimHei。

## Acknowledgements

This project implements the undergraduate thesis formatting requirements of Northwestern Polytechnical University using Quarto.

The implementation was developed with reference to the following open-source project:

- NWPU-Thesis-Template (MIT License)
